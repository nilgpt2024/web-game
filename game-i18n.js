    ...
    'zh-CN': {
        ...
        specific: {
            ...
            'Tower-Blocks': {
                ...
                builtFloorsPrefix: '你建造了 ',
                builtFloorsSuffix: ' 层高楼',
            ...
            'MountBlade': {
                ...
                instructionsTitle: '游戏说明',
                rule1: 'WASD 控制马匹移动，Shift 冲刺',
                rule2: '移动鼠标瞄准，左键拉弓/挥剑',
                rule3: '按 1/2 切换弓与剑',
                rule4: '击败敌方将领即可获胜',
                rule5: '移动端：左侧摇杆控制马头方向，镜头自动跟随，按钮射击/挥砍；滑动右侧可临时转视角',
                mobileWeapon: '当前武器',
                recenterCamera: '镜头回正',
                forwardArrow: '黄色箭头指示马头方向',
                hint: '骑上马背，拉弓挥剑，击败敌方将领！',
                restart: '重新开始',
                clearArrows: '清除箭矢'
            }
        }
    ...
    'en': {
        ...
        specific: {
            ...
            'Tower-Blocks': {
                ...
                builtFloorsPrefix: 'You built ',
                builtFloorsSuffix: ' floors!',
            ...
            'MountBlade': {
                ...
                instructionsTitle: 'How to Play',
                rule1: 'WASD to move horse, Shift to sprint',
                rule2: 'Mouse to aim, left click to draw bow / swing sword',
                rule3: 'Press 1/2 to switch bow and sword',
                rule4: 'Defeat the enemy leader to win',
                rule5: 'Mobile: left joystick steers the horse, camera auto-follows, buttons to shoot/slash; drag right side to look around',
                mobileWeapon: 'Weapon',
                recenterCamera: 'Recenter',
                forwardArrow: 'The yellow arrow shows where the horse is facing',
                hint: 'Mount up, draw your bow or swing your blade, and defeat the enemy leader!',
                restart: 'Restart',
                clearArrows: 'Clear Arrows'
            }
        }
