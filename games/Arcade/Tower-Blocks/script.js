...
var Game = /** @class */ (function () {
  function Game() {
    ...
    this.highScore = parseInt(localStorage.getItem("towerBlocksHighScore")) || 0;
    ...
    if (this.rulesBtn) {
      this.rulesBtn.addEventListener("click", function(e) {
        e.stopPropagation();
        _this.rules.classList.add("show");
      });
    }
    if (this.closeBtn) {
      this.closeBtn.addEventListener("click", function(e) {
        e.stopPropagation();
        _this.rules.classList.remove("show");
      });
    }
  }
...
/* Developer: SinceraXY */
  Game.prototype.addBlock = function () {
    ...
    if (currentScore > this.highScore) {
      ...
      this.highScoreElement.innerHTML = this.highScore;
      localStorage.setItem("towerBlocksHighScore", this.highScore);
    }
  ...
  Game.prototype.endGame = function () {
    ...
    if (this.finalScoreElement) {
      this.finalScoreElement.innerHTML = String(finalScore);
    }
  };
